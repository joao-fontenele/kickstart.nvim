...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sg', telescope.extensions.live_grep_args.live_grep_args, { desc = '[S]earch by rip[G]rep' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function(_, opts)
      ...
      require('nvim-treesitter.configs').setup(merged_opts)
